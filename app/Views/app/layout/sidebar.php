        ...
        <div class="sidebar-user-switcher user-activity-online">
            <a href="#">
                ...
                <span class="user-info-text"><?= $session->get('nama'); ?><br><span class="user-state-info">
                    <?php if($session->get('level') == 1){ echo 'Owner'; }else{ echo 'Customer'; } ?>
                </span></span>
            </a>
        </div>
    </div>
    <div class="app-menu">
        <ul class="accordion-menu">
            ...
            <li <?php if(str_contains(base_url(uri_string()),'tanggal')){ ?> class="active-page" <?php } ?>>
                <a href="#"><i class="material-icons-two-tone">calendar_month</i>Tanggal dan Harga<i
            ...
            <li <?php if(str_contains(base_url(uri_string()),'admin')){ ?> class="active-page" <?php } ?>>
                <a href="#"><i class="material-icons-two-tone">badge</i>Admin<i
                        class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                <ul class="sub-menu">
                    <li>
