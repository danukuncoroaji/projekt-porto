        ...
        <div class="page-description">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Peak Day <?= $harga['tanggal'] ?></li>
                </ol>
            </nav>
            <h1>Edit Peak Day <?= $harga['tanggal'] ?></h1>
        </div>
        <div class="card">
            <form method="POST" action="<?= base_url('/app/tanggal/update/' . $harga['id']); ?>">
                <div class="card-body">
                    <div class="row">
